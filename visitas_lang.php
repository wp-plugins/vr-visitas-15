...
$vr_lang['opt_msg_update'] 		= "set to 'file' for use the last post date, or set manually date of update";
...
$vr_lang['opt_msg_update'] 		= "valor 'archivo' usar&aacute; la fecha del &uacute;ltimo art&iacute;culo, o bien introduce a mano la fecha de actualizaci&oacute;n de la WEB";
$vr_lang['opt_msg_lang'] 		= "en [English] - es [Spanish] - it [Italian]";

...
global $vr_lang;
	...
	<div class="wrap">		
		...
		<fieldset class="options">
			...
			<form method="post" name="validar_opciones" action="visitas_15a.php?page=options">
	...
	<div class="wrap">		
		...
		<fieldset class="options">
			...
			<table width="100%" cellspacing="3" cellpadding="3">
				<tr>
					<td>
						<form method='post' action='visitas_15a.php?page=words'>
					...
					<td style='text-align: right'>
						<form method='post' action='visitas_15a.php?page=borrar'>
							<table cellspacing="3" cellpadding="3">
							<tr>
...
<script type="text/javascript">
	...
	<div class="wrap">
		...
		<fieldset class="options">
			...
			<form name="delfilter" id="delfilter" method='post' action='visitas_15a.php?page=filtro'>
